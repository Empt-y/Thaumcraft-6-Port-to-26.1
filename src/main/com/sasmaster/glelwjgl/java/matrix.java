...
public class matrix
{
    ...
    public static void rotx_cs_d(double cosine, double sine) {
        GL11.glMultMatrixd(getBufferedMatrix(urotx_cs_d(cosine, sine)));
    }
    ...
    public static void roty_cs_d(double cosine, double sine) {
        GL11.glMultMatrixd(getBufferedMatrix(uroty_cs_d(cosine, sine)));
    }
    ...
    public static void rotz_cs_d(double cosine, double sine) {
        GL11.glMultMatrixd(getBufferedMatrix(urotz_cs_d(cosine, sine)));
    }
    ...
    public static void rot_cs_d(double cosine, double sine, char axis) {
        GL11.glMultMatrixd(getBufferedMatrix(urot_cs_d(cosine, sine, axis)));
    }
    ...
    public static void rot_prince_d(double theta, char axis) {
        GL11.glMultMatrixd(getBufferedMatrix(urot_prince_d(theta, axis)));
    }
    
    public static void rot_axis_d(double omega, double[] axis) {
        GL11.glMultMatrixd(getBufferedMatrix(urot_axis_d(omega, axis)));
    }
    
    public static void rot_about_axis_d(double angle, double[] axis) {
        GL11.glMultMatrixd(getBufferedMatrix(urot_about_axis_d(angle, axis)));
    }
    
    public static void rot_omega_d(double[] axis) {
        GL11.glMultMatrixd(getBufferedMatrix(urot_omega_d(axis)));
    }
